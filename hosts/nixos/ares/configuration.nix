{ inputs, pkgs, ... }:
{
  ...
  assertions = [
    {
      # cf938378 (2026-07-22 bump): decky-loader 3.2.6 still pnpm_9, exception still needed
      assertion = inputs.jovian-nixos.rev == "cf9383788741bdabcb13f5c323a978fd63e681e8";
